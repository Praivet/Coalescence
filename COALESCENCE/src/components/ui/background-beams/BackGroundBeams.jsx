...
export const BackgroundBeams = React.memo(({ className }) => {
    return (
        <div className={cn("background-beams-container", className)}>
            <svg
                ...
                <defs>
                    {pathData.map((_, i) => (
                        <linearGradient
                            ...
                            y2="100%"
                        >
                            <stop offset="0%" stopColor="#fc6f18ff" stopOpacity="0" />
                            <stop offset="20%" stopColor="#e2660eff" stopOpacity="1" />
                            <stop offset="50%" stopColor="#c7630cff" stopOpacity="1" />
                            <stop offset="80%" stopColor="#d75809ff" stopOpacity="1" />
                            <stop offset="100%" stopColor="#cd600dff" stopOpacity="0" />
                        </linearGradient>
                    ))}
                </defs>
            </svg>
